...
public class BriImageAdapter extends BaseAdapter {

	private Context mContext;
	private LayoutInflater mInflater;
	private int mflag;
	
	private static final int[] images2 = {R.drawable.yong3, R.drawable.yong4, R.drawable.yong6};
	private static final int[] images1 = {R.drawable.yiluo1, R.drawable.yiluo2, R.drawable.yiluo3};

	public BriImageAdapter(Context context,int flag) {
		mContext = context;
