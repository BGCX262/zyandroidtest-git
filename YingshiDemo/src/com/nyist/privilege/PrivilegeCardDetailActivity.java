...
import com.nyist.tool.GroupImageAdapter;
import com.nyist.tool.CardImageAdapter;
...
public class PrivilegeCardDetailActivity extends Activity {  
	  private ImageView imageView=null;
	  private TextView textView1,textView2,textView3,textView4;	
	  private int Flag;
	  public void onCreate(Bundle savedInstanceState) {
		 super.onCreate(savedInstanceState);
		 setContentView(R.layout.privilege_tiem_detail);
	        Intent intent=null;
			intent = getIntent();
	  ...
	  void circleimage() {
			...
			viewFlow.setAdapter(new  CardImageAdapter (this,Flag));
